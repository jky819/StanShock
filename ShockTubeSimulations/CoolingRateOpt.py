...
# Sim, Simulation conditions: discretization sizes (nXCoarse, nXFine), tFinal, theta
...
class CoolingOpt:
    ...
    def GetCoolInert(self):
        ...
        t0 = time.clock()
        eps = 0.01 ** 2.0
        ss.optimizeExpFanCooling(tFinal, theta=self.Sim['theta'], eps=eps, maxIter=100)
        t1 = time.clock()
